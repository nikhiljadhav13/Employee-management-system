...
const TaskListNumbers = ({data}) => {
  return (
    <div className='flex justify-between mt-4 screen gap-5'>
        <div className=' w-[45%] py-5 px-9 bg-red-500 rounded-xl'>
         ...
         <div className=' w-[45%] py-5 px-9 bg-blue-500 rounded-xl'>
         ...
         <div className=' w-[45%] py-5 px-9 bg-green-500 rounded-xl'>
        ...
        </div> <div className=' w-[45%] py-5 px-9 bg-yellow-500 rounded-xl'>
