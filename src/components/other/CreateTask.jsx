      ...
      <div className="p-5 rounded mt-7 bg-[#1c1c1c]">
        <form className="flex flex-wrap w-full items-start justify-between ">
          ...
          <div className="w-2/5 flex flex-col items-start">
            ...
            <textarea className="w-full h-46 text-sm py-2 px-4 outline-none bg-transparent border-[1px] border-gray-400" rows={"5"} cols={"20"}></textarea>
          <button className="bg-emerald-600 px-5 py-1 rounded text-sm mt-4 w-full">Create Task</button>
          </div>
